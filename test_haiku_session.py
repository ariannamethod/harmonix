...
os.chdir('/home/user/harmonix/haiku')
sys.path.insert(0, '/home/user/harmonix/haiku')
...
harmonix = Harmonix('haiku/state/cloud.db')
haiku_gen = HaikuGenerator(SEED_WORDS, 'haiku/state/mathbrain.json', 'haiku/state/cloud.db')
