"""
Sonnet Tokenizer - Hybrid tokenization system
...
- MetaSonnet internal reflections (word-level understanding)
- SonnetRAE compression (semantic features)
...
class SonnetTokenizer:
    """
    Hybrid tokenizer for Sonnet module.
    ...
    def __init__(self, vocab_size: int = 5000, state_path: str = 'state/sonnet_tokenizer.json'):
...
if __name__ == '__main__':
    tokenizer = SonnetTokenizer(vocab_size=1000)  # Smaller for testing
