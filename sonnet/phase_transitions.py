...
class PhaseTransitions:
    ...
    - Novelty decay rate
    - MetaSonnet reflection frequency
    ...
    def _adjust_temperatures(self, metrics: Dict):
        ...
        if self.current_state.phase == Phase.LIQUID:
            ...
            if dissonance > 0.7:
                self.current_state.temperature_sonnet = min(1.0, self.current_state.temperature_sonnet + 0.05)
            elif dissonance < 0.3:
                self.current_state.temperature_sonnet = max(0.6, self.current_state.temperature_sonnet - 0.05)
    ...
    def get_temperatures(self) -> Tuple[float, float]:
        """Get current temperatures for (sonnet, haiku)."""
        return (
            self.current_state.temperature_sonnet,
    ...
    def get_phase_info(self) -> Dict:
        ...
        return {
            ...
            'temperature_sonnet': self.current_state.temperature_sonnet,
    ...
    def _load_state(self):
        ...
        try:
            ...
            self.current_state = PhaseState(
                ...
                temperature_sonnet=state.get('temperature_sonnet', 0.8),
...
if __name__ == '__main__':
    ...
    for i, metrics in enumerate(scenarios):
        ...
        print(f"Temperatures: sonnet={state.temperature_sonnet:.2f}, haiku={state.temperature_haiku:.2f}")
